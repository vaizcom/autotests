...
def test_milestone_total_task_count_increases_after_task_creation(owner_client, main_space, create_task_in_main, main_board):
    ...
    try:
        ...
        with allure.step("Создаём последовательно рандомное количество задач (от 1 до 10) с этим milestone и проверяем total"):
        ...
        with allure.step("Проверяем итоговое значение total после добавления всех задач"):
